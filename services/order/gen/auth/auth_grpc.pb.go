...
const (
	AuthService_Register_FullMethodName      = "/auth_server.AuthService/Register"
	AuthService_Login_FullMethodName         = "/auth_server.AuthService/Login"
	AuthService_RefreshToken_FullMethodName  = "/auth_server.AuthService/RefreshToken"
	AuthService_ValidateToken_FullMethodName = "/auth_server.AuthService/ValidateToken"
	AuthService_GetUser_FullMethodName       = "/auth_server.AuthService/GetUser"
)
...
type AuthServiceClient interface {
	...
	GetUser(ctx context.Context, in *TokenRequest, opts ...grpc.CallOption) (*User, error)
}
...
func (c *authServiceClient) ValidateToken(ctx context.Context, in *TokenRequest, opts ...grpc.CallOption) (*ValidateTokenResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *authServiceClient) GetUser(ctx context.Context, in *TokenRequest, opts ...grpc.CallOption) (*User, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(User)
...
type AuthServiceServer interface {
	...
	GetUser(context.Context, *TokenRequest) (*User, error)
...
func (UnimplementedAuthServiceServer) ValidateToken(context.Context, *TokenRequest) (*ValidateTokenResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ValidateToken not implemented")
}
func (UnimplementedAuthServiceServer) GetUser(context.Context, *TokenRequest) (*User, error) {
...
func _AuthService_GetUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).GetUser(ctx, req.(*TokenRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "auth_server.AuthService",
